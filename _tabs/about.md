...
- ML/DL ➔ Time-series Forecasting, Computer Vision, Anomaly detection
- XAI
- MLOps, Google Cloud
...
- [`2022 데이터 크리에이터 캠프 최우수상 수상`](https://drive.google.com/file/d/1NtEyqeSgHrYoK_5EefvUGuhhpCUbOBIn/view?usp=sharing) | 2022.10 - 2022.11  
  ➔ 자기지도학습의 SimCLR 모델으로 일러스트/실사 사진에 대한 high-level feature 추출 후 GMM 클러스터링
  ➔ VGG16에 Residual block을 추가하여 일러스트 이미지 분류를 위한 VGG 수정모형 제작

- [`AI 융합기술을 활용한 의료·산업수학 문제해결 워크숍 참여`](https://drive.google.com/file/d/1AK840lnLGfhHsK1qMFDd-1164wQ8_Bt5/view?usp=share_link) | 2022.09  
  ➔ 보행데이터 기반 파킨슨 질환 예측 문제에 참여  
  ➔ 위치 마커 시계열 보행 데이터에 대한 topological feature을 생성하여 k-means clustering으로 분석함

- [`LG Aimers 1기`](https://drive.google.com/file/d/1ZFSNnhh82qgDVpUOzQb7Aj1dsbjWydWw/view?usp=sharing) | 2022.07 - 2022.08  
  ➔ 머신러닝 접근법 및 XAI, 인과추론 그리고 최신 AI 트렌드를 학습함  
  ➔ [자율주행 센서 안테나 성능예측 해커톤 대회 : TOP 4%](https://drive.google.com/file/d/1M5hNPxIXJt81aMJf0sxRJ-aHsbJXst0L/view?usp=sharing)

- [`AI 논문 리뷰 스터디`](https://github.com/standing-o/Machine-learning_Paper_review) | 2020.08 - 2022.08  
  ➔ 여러 전공의 대학(원)생이 모여 ML/DL 이론 및 최신 동향을 논문을 통해 파악하고 매달 세미나를 진행  
  ➔ 개인적으로는 Optimization, Time-series forecasting, XAI, Computer Vision 분야의 논문을 공부함  
  ➔ [노션페이지](https://www.notion.so/AI-8cf628b189774b4b9e05efaf84b20033) 

- [`중고차 가격 예측 경진대회 1등 수상`](https://dacon.io/competitions/official/235901/codeshare/5089?page=1&dtype=recent) | 2022.05 - 2022.06  
  ➔ Lgbm, Catboost, Xgb, Random forest, Extra tree 5가지 모델을 앙상블, Automl을 활용한 파라미터 튜닝

- [`RnD 인턴십 프로그램`](https://drive.google.com/file/d/1TlRCam1d6gueXoRBfYl4eeIS9BBuynFx/view?usp=sharing) | 2019.10 - 2019.12 <sup>1</sup>, 2021.10 - 2022.01 <sup>2</sup>, 2022.10 - 2022.12 <sup>3</sup>  
  ➔ <sup>1</sup> 머신러닝 분야를 수학•통계•컴퓨터적인 관점에서 분석하고 복합적으로 연구함  
  ➔ <sup>2</sup> 수치적 방법론과 신경망을 이용한 전염병 확산 예측  
  ➔ <sup>3</sup> CNN (YOLO) 을 활용한 자연재해 이미지 분석 및 피해 예측

- [`교내 빅데이터 아이디어 공모전 장려상 수상`](https://drive.google.com/file/d/1U5yodSrPhVieCUHytCXVztGa24MydE0T/view?usp=sharing) | 2021.11 - 2021.12  
  ➔ 빅데이터 분석을 통한 교내시설 활용도 향상을 주제로 객체인식 알고리즘을 활용한 식당 혼잡도 측정 서비스를 제안함

- [`데이터 분석 및 AI 동아리` `수DA쟁이`](https://github.com/standing-o/Data_Analysis_Club) | 2019.11 - 2021.03  
  ➔ 매주 머신러닝, 딥러닝, 캐글, OpenCV, NLP를 주제로 세미나를 진행, 캐글/데이콘 등 공모전에 함께 참여  
  ➔ [<u>동아리 과제</u>](https://github.com/standing-o/Data_Analysis_Club_Assignment)를 제작하는 역할을 수행하여 리더십을 키우고 AI분야의 전반적인 큰 틀을 파악함  
  ➔ 팀프로젝트 : [<u>카사바 잎 분류</u>](https://github.com/standing-o/Cassava_Leaf_Disease_Classification), [<u>흉부 X-ray 이상탐지</u>](https://github.com/standing-o/Chest_X-ray_Abnormalities_Detection), [<u>과학서적 토픽 모델링</u>](https://github.com/standing-o/Topic_modeling_of_scientific_publications_with_LDA), [<u>CT 이미지 향상•분류</u>](https://github.com/standing-o/CT_Medical_image_analysis)
  
- [`자연과학대학 학술 창의력 경연대회 은상 수상`](https://github.com/standing-o/Air_pollution_forecasting_with_Numerical_modeling_and_ML) | 2020.08 - 2020.10  
  ➔ Convection-diffusion 모델과 LSTM을 이용한 대기 오염 예측

- [`자료구조 알고리즘 스터디` `Trinity`](https://github.com/standing-o/Data_Structure_and_Algorithm) | 2020.07 - 2020.09  
  ➔ 매주 자료구조 알고리즘의 중요한 개념을 공부하고 자료를 공유하기 위한 발표를 진행  
  ➔ [학습 로드맵](https://github.com/stack07142/BOJ/blob/master/README.md)  

## <u>Projects</u>
- [`머신러닝을 이용한 주식 및 비트코인 시계열 예측`](https://github.com/standing-o/Time-series_price_analysis) | 2021.07 - Present  
   ➔ LSTM, Wavenet, LightGBM, ...

- [`딥러닝을 적용한 배터리 노화상태 (State of Health) 예측`](https://github.com/standing-o/SoH_estimation_of_Lithium-ion_battery) | 2020.11 - 2020.12  
   ➔ LSTM을 활용하여 리튬-이온 배터리의 잔여 수명을 식별하기 위한 SoH 예측

- [`YOLO-v3를 이용한 잔여 좌석수 카운팅 `](https://github.com/standing-o/People_Counter_using_Object_Detection) | 2020.10 - 2020.11  
   ➔ 강의실 CCTV 이미지에 Object detection 활용

- [`U-GAT-IT을 활용한 지브리 Style image transfer 제작`](https://github.com/standing-o/Image-to-Image_translation_with_U-GAT-IT) | 2020.06 - 2020.08  
   ➔ 사람의 셀카 이미지를 지브리 영화 스타일로 변환하는 GAN

- [`Real-time 꽃 이미지 인식•분류 안드로이드 앱 개발`](https://github.com/standing-o/Image_Recognition_Android_Application) | 2020.06 - 2020.09  
➔ 딥러닝 분류모델 구축 및 평가, 이미지 데이터 크롤링, 모바일 앱 디자인 

## <u>Technical Skills</u>
- Proficient

|     Language      | DL Framework | Collaboration |
| :---------------: | :----------: | :-----------: |
| Python, Matlab, R |  Tensorflow  |    Github     |
...
- 빅데이터 분석기사 (Big Data Analysis Certification KR)
- Advanced Data Semi-Analytics (ADsP)
- 워드프로세서

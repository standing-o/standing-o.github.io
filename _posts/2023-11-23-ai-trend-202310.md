...
image:
  path: 20231123-t.jpg
  alt: ""
description: 2023년 10월의 인공지능 기술 트렌드를 소개합니다 | 인공지능 AI 트렌드, 이슈, 동향
---
...
## 💡 **News**
### WGA와 AMPTP가 계약 합의에 도달하여 146일간의 작가 파업을 종결 [^ref1]
...
- 3D 의료 이미지를 위해 SAM을 수정하는 가장 포괄적인 연구인 **SAM-Med3D**를 제안합니다
